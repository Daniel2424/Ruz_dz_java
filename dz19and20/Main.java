...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("by iterating over ArrayList: " + (System.currentTimeMillis() - m) + " ms");
        ...
        System.out.println("binary search on sorted ArrayList: " + (System.currentTimeMillis() - m) + " ms");
        ...
        System.out.println("search in HashSet: " + (System.currentTimeMillis() - m) + " ms");
        ...
        System.out.println("by searching in a TreeSet: " + (System.currentTimeMillis() - m) + " ms");
