...
public class Company {
    ...
    public void hire(int r){
            switch (r){
                case 0:
                    subordinates.add(new Operator("Name" + subordinates.size(), "Surname" + subordinates.size(),
                            (int)(70000 + Math.random() * 10000 )));
                    break;
                case 1:
                    subordinates.add(new Manager("Name" + subordinates.size(), "Surname" + subordinates.size(),
                            (int)(100000 + Math.random() * 25000 )));
                    break;
                case 2:
                    topManagers.add(new TopManager("Name" + topManagers.size(), "Surname" + topManagers.size(),
    ...
    public void hireAll(int r, int size){
        ...
        while ( counter < size ){
            switch (r){
                case 0:
                    subordinates.add(new Operator("Daniil" + subordinates.size(), "Ruzhkov" + subordinates.size(),
                            (int)(70000 + Math.random() * 10000 )));
                    break;
                case 1:
                    subordinates.add(new Manager("Daniil" + subordinates.size(), "Ruzhkov" + subordinates.size(),
                            (int)(100000 + Math.random() * 25000 )));
                    break;
                case 2:
                    topManagers.add(new TopManager("Daniil" + topManagers.size(), "Ruzhkov" + topManagers.size(),
                            (int)(300000 + Math.random() * 50000 ), subordinates));
                    break;
            }
            counter++;
    ...
    public void dismiss(int count){
        ...
        System.out.println("50% of employees are laid off\n");
    }
